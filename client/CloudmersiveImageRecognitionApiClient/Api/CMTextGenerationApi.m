#import "CMTextGenerationApi.h"
#import "CMQueryParamCollection.h"
#import "CMApiClient.h"
#import "CMCreateHandwritingRequest.h"


@interface CMTextGenerationApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMTextGenerationApi

NSString* kCMTextGenerationApiErrorDomain = @"CMTextGenerationApiErrorDomain";
NSInteger kCMTextGenerationApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) textGenerationCreateHandwritingPngWithRequest: (CMCreateHandwritingRequest*) request
    ...
    if (request == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMTextGenerationApiErrorDomain code:kCMTextGenerationApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/image/text/create/handwriting/png"];
